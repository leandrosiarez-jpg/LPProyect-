...
Su función principal es garantizar que el software que corre en la ECU es el original y no fue modificado. Si alguien intenta flashear firmware no autorizado, el chip detecta que la firma digital no coincide y rechaza la actualización.
...
Las medidas de seguridad aplicadas sobre OBD-II incluyen autenticación de herramientas (solo equipos certificados pueden ejecutar comandos de escritura) y logs de acceso con marca temporal.
