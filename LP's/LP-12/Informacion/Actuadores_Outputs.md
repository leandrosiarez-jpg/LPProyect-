...
- **Prioridad**: Son outputs de máxima jerarquía. Ninguna señal de confort o entretenimiento puede interferir con ellos. Más detalles en [Jerarquia_de_Señales.md](./Jerarquia_de_Señales.md).
...
- **Analogía**: Son la capa de presentación del sistema, donde la [Objetividad](../../../MAIN_VAULT/Objetividad.md) técnica se convierte en algo legible para el usuario.
