...
- El cuidado de la información limpia (Como vieron en "Forma normal" en base de datos. No repetir, lograr atomicidad, relacionar por id)
- El fomento de otros procesos en base a información propia
- El respeto hacia las formas de los proyectos de otros

Este documento esta pensado para ser editado tanto por mi, como por ustedes
Este documento requiere ser leido multiples veces, aquél que no tenga clara la comprensión de este documento no va a aprobar la materia
