...
- **SDN (Software Defined Networking)**: Arquitectura que utiliza controladores de software para dirigir el tráfico de la red.
...
- **API**: Lógica creada para que una aplicación o computadora se comunique con otra.
- **Servidor**: Lugar donde se almacena información; la solicita a través de los **[[Endpoint]]**.
- **Switch**: Dispositivo por donde pasa la información para facilitar la conexión.
- **Conexión**: La información viaja a través de los **[[Socket]]** hasta llegar al servidor.
